    ...
    return {
      ...
      compile: function () {
        return function link(scope, element, attrs) {
          'use strict';
          var id, width, height, margin, widthTracker = 0, heightTracker = 0, columns = 1, columnTracker = 0, padding = 10, paddingStr, svgNamespace = 'http://www.w3.org/2000/svg', svg, g, labels, styles, classes, shapes, x = 0, y = 0, container;
...
'use strict';
angular.module('d3.bundle', ['nvd3ChartDirectives']);